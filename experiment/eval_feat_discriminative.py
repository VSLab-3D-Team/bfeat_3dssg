...
if __name__ == "__main__":
    ...
    if not os.path.exists(f"/media/michael/ssd1/SceneGraph/bfeat_object_experiments/{exp_name}"):
        os.makedirs(f"/media/michael/ssd1/SceneGraph/bfeat_object_experiments/{exp_name}")
    ...
    with torch.no_grad():
        for i, (data_t1, data_t2, obj_data, zero_mask, text_feat, label) in enumerate(t_loader):
            ...
            with open(f"/media/michael/ssd1/SceneGraph/bfeat_object_experiments/{exp_name}/batch_{i}.pkl", "wb") as f:
